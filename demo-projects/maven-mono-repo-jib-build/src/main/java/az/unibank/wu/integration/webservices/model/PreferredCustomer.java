 ...
 *         &lt;element name="mktg_comm_opt_in" type="{http://www.westernunion.com/schema/xrsi}mktg_opt_in_out" minOccurs="0"/>
 ...
 *         &lt;element name="PS_TC_notification_preference" type="{http://www.westernunion.com/schema/xrsi}PS_TC_notification_preference" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "preferred_customer", namespace = "http://www.westernunion.com/schema/xrsi", propOrder = {
...
public class PreferredCustomer {
    ...
    @XmlElement(name = "mktg_comm_opt_in")
    @XmlSchemaType(name = "string")
    protected MktgOptInOut mktgCommOptIn;
    ...
    @XmlElement(name = "PS_TC_notification_preference")
    @XmlSchemaType(name = "string")
    protected PSTCNotificationPreference pstcNotificationPreference;
    ...
    /**
     * Gets the value of the mktgCommOptIn property.
     * 
     * @return
     *     possible object is
     *     {@link MktgOptInOut }
     *     
     */
    public MktgOptInOut getMktgCommOptIn() {
        return mktgCommOptIn;
    }

    /**
     * Sets the value of the mktgCommOptIn property.
     * 
     * @param value
     *     allowed object is
     *     {@link MktgOptInOut }
     *     
     */
    public void setMktgCommOptIn(MktgOptInOut value) {
        this.mktgCommOptIn = value;
    }
    ...
    /**
     * Gets the value of the pstcNotificationPreference property.
     * 
     * @return
     *     possible object is
     *     {@link PSTCNotificationPreference }
     *     
     */
    public PSTCNotificationPreference getPSTCNotificationPreference() {
        return pstcNotificationPreference;
    }

    /**
     * Sets the value of the pstcNotificationPreference property.
     * 
     * @param value
     *     allowed object is
     *     {@link PSTCNotificationPreference }
     *     
     */
    public void setPSTCNotificationPreference(PSTCNotificationPreference value) {
        this.pstcNotificationPreference = value;
    }
