 ...
 *         &lt;element name="APN_Receiver_Message" type="{http://www.westernunion.com/schema/xrsi}APN_Receiver_Message" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "send-money-store-reply", namespace = "http://www.westernunion.com/schema/xrsi", propOrder = {
    "sender",
    "receiver",
    "paymentDetails",
    "financials",
    ...
    extends ReplyTransactionBase
{
    ...
    @XmlElement(name = "APN_Receiver_Message")
    protected String apnReceiverMessage;
    ...
    /**
     * Gets the value of the apnReceiverMessage property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getAPNReceiverMessage() {
        return apnReceiverMessage;
    }

    /**
     * Sets the value of the apnReceiverMessage property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setAPNReceiverMessage(String value) {
        this.apnReceiverMessage = value;
    }
